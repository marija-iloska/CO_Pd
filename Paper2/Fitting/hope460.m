...
%[ k_oB, k_Bo, k_Ao, k_oA, k_AB, k_BA, k_oX, k_Xo, dlms] = get_460k_NM(cov, time, covA, covB, dt, tp_idx, tp_AB, tN(end), P, M);
[k_oB, k_Bo, k_Ao, k_oA, k_AB, k_BA, dlms] = get_460k_NM(cov, time, covA, covB, dt, tp_idx, tp_AB, tN(end), P, M, cut_off1);
...
[theta_A, theta_B] = fitting460_NM(cov, covA, covB, dtime, time, vals, tp_AB, tp_idx, M, P);
...
save('Data/460ks_fix.mat', 'vals', 'dlms')
