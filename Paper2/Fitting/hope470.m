...
[k_oB, k_Bo, k_Ao, k_oA, k_AB, k_BA, dlms] = get_470k_NM(cov, time, covA, covB, dt, tp_idx, tp_AB, tN(end), P, M, cut_off1);
...
[theta_A, theta_B] = fitting470_NM(cov, covA, covB, dtime, time, vals, tp_AB, tp_idx, M, P);
